...
(function(){
  ...
  if(cD&&cR){
    ...
    document.querySelectorAll('a,button,.p-card,.sp-img,.sp-gallery-hero,.cp-cat').forEach(function(el){
    ...
    document.querySelectorAll('.p-card,.sp-img,.sp-gallery-hero,.ph-hero-img,.cp-cat').forEach(function(el){
