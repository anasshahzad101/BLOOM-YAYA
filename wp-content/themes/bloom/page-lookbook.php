...
<div class="preloader" id="preloader">
  ...
  <div class="pl-sub">The Lookbook · SS26</div>
...
<section class="lb-hero" id="lbHeroSection" aria-labelledby="lbTitle">
  <div class="lb-hero-img" style="background-image:url('<?php echo get_template_directory_uri(); ?>/assets/img/bf068.jpg');" role="img" aria-label="SS26 Lookbook cover"></div>
...
<section class="lb-credits" aria-label="Editorial credits">
  ...
  <div><div class="lb-cred-l">Looks</div><div class="lb-cred-v">Twelve · Across seven maisons</div></div>
</section>

<!-- ═══ INTRO ═══ -->
<section class="lb-intro">
  <p class="lb-intro-q" id="lbIntro">
    A gown is a <em>vow</em> — to the woman who wears it, to the <em>room</em> she enters, and to the moment she <em>chose</em> to be remembered.
  </p>
  <div class="lb-intro-meta">The Vow Collection · SS26</div>
</section>

<!-- ═══ LOOK 01 — Split, image left ═══ -->
<section class="lb-section warm">
  <div class="lb-split rv">
    <div class="lb-split-img">
      <div class="lb-split-img-bg" style="background-image:url('<?php echo get_template_directory_uri(); ?>/assets/img/bf032.jpg');" role="img" aria-label="Look 01 Aurora — Elie Saab gown"></div>
    ...
    <div class="lb-split-meta">
      ...
      <div class="lb-meta-designer">Elie Saab · SS26</div>
      <p class="lb-meta-desc">Ivory tulle, embroidered by hand over forty hours. The kind of gown that arrives before its wearer does — and stays in the room long after she has left.</p>
      <a href="<?php echo esc_url( home_url("/collection/") ); ?>#evening" class="lb-meta-cta">Shop the look →</a>
    </div>
  </div>
</section>
...
<section class="lb-section">
  ...
  <div class="lb-two">
    <article class="lb-tile rv rv-d1">
      <div class="lb-tile-img" style="background-image:url('<?php echo get_template_directory_uri(); ?>/assets/img/bf033.jpg');" role="img" aria-label="Look 02 Solène — Marchesa cocktail dress"></div>
      ...
      <div class="lb-tile-ct">
        ...
        <h3 class="lb-tile-name">Solène</h3>
        <div class="lb-tile-des">Marchesa · Italian crepe with crystal beadwork</div>
      </div>
    </article>
    <article class="lb-tile rv rv-d2">
      <div class="lb-tile-img" style="background-image:url('<?php echo get_template_directory_uri(); ?>/assets/img/bf034.jpg');" role="img" aria-label="Look 03 Mira — Saiid Kobeisy"></div>
      <div class="lb-tile-ov"></div>
      <div class="lb-tile-frame"></div>
      ...
      <div class="lb-tile-ct">
        ...
        <div class="lb-tile-des">Saiid Kobeisy · Metallic jacquard, structured shoulder</div>
      </div>
    </article>
  </div>
</section>
...
<!-- ═══ LOOK 04 — Full-bleed ═══ -->
<section class="lb-full rv" aria-label="Look 04 Vespera — Zuhair Murad">
  <div class="lb-full-img" style="background-image:url('<?php echo get_template_directory_uri(); ?>/assets/img/bf035.jpg');" role="img" aria-label="Vespera silhouette"></div>
  ...
  <div class="lb-full-ct">
    ...
    <div class="lb-full-info">
      ...
      <div class="lb-full-designer">Zuhair Murad · SS26</div>
    </div>
  </div>
</section>

<!-- ═══ LOOK 05–07 — 3-up grid ═══ -->
<section class="lb-section warm">
  <div class="lb-row-head rv">
  ...
  <div class="lb-three">
    <article class="lb-tile rv rv-d1">
      <div class="lb-tile-img" style="background-image:url('<?php echo get_template_directory_uri(); ?>/assets/img/bf036.jpg');" role="img" aria-label="Look 05 Layla — Reem Acra"></div>
      <div class="lb-tile-ov"></div>
      <div class="lb-tile-frame"></div>
    ...
    <article class="lb-tile rv rv-d2">
      <div class="lb-tile-img" style="background-image:url('<?php echo get_template_directory_uri(); ?>/assets/img/bf037.jpg');" role="img" aria-label="Look 06 Selene — Tony Ward"></div>
      <div class="lb-tile-ov"></div>
      <div class="lb-tile-frame"></div>
    ...
    <article class="lb-tile rv rv-d3">
      <div class="lb-tile-img" style="background-image:url('<?php echo get_template_directory_uri(); ?>/assets/img/bf038.jpg');" role="img" aria-label="Look 07 Yasmin — Jovani"></div>
      <div class="lb-tile-ov"></div>
      <div class="lb-tile-frame"></div>
...
<!-- ═══ LOOK 08 — Split reversed (image right) ═══ -->
<section class="lb-section dark">
  <div class="lb-split reverse rv">
    <div class="lb-split-meta">
      ...
      <div class="lb-meta-designer">Georges Hobeika · SS26</div>
    ...
    <div class="lb-split-img">
      <div class="lb-split-img-bg" style="background-image:url('<?php echo get_template_directory_uri(); ?>/assets/img/bf039.jpg');" role="img" aria-label="Look 08 Noor — Georges Hobeika"></div>
      <div class="lb-split-frame"></div>
...
<section class="lb-section">
  ...
  <div class="lb-two">
    <article class="lb-tile rv rv-d1">
      <div class="lb-tile-img" style="background-image:url('<?php echo get_template_directory_uri(); ?>/assets/img/bf040.jpg');" role="img" aria-label="Look 09 Lina — Naeem Khan"></div>
      <div class="lb-tile-ov"></div>
      <div class="lb-tile-frame"></div>
      ...
      <div class="lb-tile-ct">
        ...
        <div class="lb-tile-des">Naeem Khan · Hand-painted silk</div>
      </div>
    </article>
    <article class="lb-tile rv rv-d2">
      <div class="lb-tile-img" style="background-image:url('<?php echo get_template_directory_uri(); ?>/assets/img/bf041.jpg');" role="img" aria-label="Look 10 Dalia — Elie Saab"></div>
      <div class="lb-tile-ov"></div>
      <div class="lb-tile-frame"></div>
      ...
      <div class="lb-tile-ct">
        ...
        <div class="lb-tile-des">Elie Saab · Crystal embellishment</div>
      </div>
    </article>
  </div>
</section>

<!-- ═══ LOOK 11 + 12 — Bridal closing pair ═══ -->
<section class="lb-section warm">
  <div class="lb-row-head rv">
  ...
  <div class="lb-two">
    <article class="lb-tile rv rv-d1">
      <div class="lb-tile-img" style="background-image:url('<?php echo get_template_directory_uri(); ?>/assets/img/bf042.jpg');" role="img" aria-label="Look 11 Faye — Marchesa Bridal"></div>
      <div class="lb-tile-ov"></div>
      <div class="lb-tile-frame"></div>
      ...
      <div class="lb-tile-ct">
        ...
        <div class="lb-tile-des">Marchesa Bridal · Cathedral length</div>
      </div>
    </article>
    <article class="lb-tile rv rv-d2">
      <div class="lb-tile-img" style="background-image:url('<?php echo get_template_directory_uri(); ?>/assets/img/bf043.jpg');" role="img" aria-label="Look 12 Sahar — Reem Acra Bridal"></div>
      <div class="lb-tile-ov"></div>
      <div class="lb-tile-frame"></div>
      ...
      <div class="lb-tile-ct">
        ...
        <div class="lb-tile-des">Reem Acra · Hand-beaded</div>
      </div>
    </article>
  </div>
</section>
...
<section class="lb-end" aria-label="Editorial credits">
  ...
  <div class="lb-end-credits">
    ...
    <div class="lb-end-cred"><div class="l">Location</div><div class="v">Al Murabba Palace · Riyadh</div></div>
    <div class="lb-end-cred"><div class="l">Season</div><div class="v">Spring / Summer 2026</div></div>
  </div>
  <a href="<?php echo esc_url( home_url("/collection/") ); ?>" class="btn-gold"><span>Shop the collection</span><span class="arrow">→</span></a>
</section>
...
/* ═══ SUBTLE PARALLAX ON LOOK IMAGES ═══ */
const parEls=[];
