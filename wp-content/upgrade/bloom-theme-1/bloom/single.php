<?php
/**
 * Template â€” Single Post (native WP post)
 */
...
if ( ! $thumb ) $thumb = get_post_meta( $pid, '_bloom_post_image', true );
if ( ! $thumb ) $thumb = 'https://images.unsplash.com/photo-1581044777550-4cfa60707c03?w=2000&q=85&auto=format';
  ...
  <section class="sp-post-related">
    ...
    <div class="journal-grid">
      <?php while ( $related->have_posts() ) : $related->the_post();
        ...
        if ( ! $rthumb ) $rthumb = get_post_meta( get_the_ID(), '_bloom_post_image', true );
        if ( ! $rthumb ) $rthumb = 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=900&q=85&auto=format';
      ...
      ?>
        <a class="jnl-card" href="<?php the_permalink(); ?>" style="text-decoration:none;color:inherit;">
          ...
          <div class="jnl-meta"><?php if ( $rcat ) : ?><?php echo esc_html( $rcat ); ?><span class="sep">Â·</span><?php endif; ?><?php echo esc_html( get_the_date( 'M Y' ) ); ?></div>
          <h3 class="jnl-title"><?php the_title(); ?></h3>
          <p class="jnl-excerpt"><?php echo esc_html( wp_trim_words( get_the_excerpt(), 22, 'â€¦' ) ); ?></p>
