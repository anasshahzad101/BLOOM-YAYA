...
<section class="cp-hero" id="cpHeroSection">
  <div class="cp-hero-img" style="background-image:url('https://images.unsplash.com/photo-1581338834647-b0fb40704e21?w=2000&q=85&auto=format');"></div>
  ...
  <div class="cp-hero-ct">
    ...
    <p class="cp-sub">Two hundred and forty pieces, curated across seven categories â€” every silhouette chosen for the woman who knows the difference between a dress and an entrance.</p>
  </div>
</section>

<!-- â•â•â• STICKY CATEGORY TABS â•â•â• -->
...
<!-- â•â•â• BIG EDITORIAL BENTO â•â•â• -->
<section class="cp-bento-section" id="cpBento">
  <div class="cp-bento-head rv">
    ...
    <p class="cp-bento-sub">From the gown that closes the evening to the blouse that opens the morning â€” every piece in our collection passes through the eye of a stylist before it earns its place.</p>
  </div>

  <div class="cp-bento">
    <!-- Evening Dresses â€” Featured -->
    <a href="<?php echo esc_url( home_url("/collection/evening-dresses/") ); ?>" id="evening" class="cp-cat featured ev rv rv-d1">
      <div class="cp-cat-img" style="background-image:url('https://images.unsplash.com/photo-1581044777550-4cfa60707c03?w=1600&q=85&auto=format');"></div>
      <div class="cp-cat-ov"></div>
      <div class="cp-cat-frame"></div>
      <span class="cp-cat-num">01 / 07</span>
      <div class="cp-cat-ct">
        <span class="cp-cat-tag">Signature Category Â· 64 pieces</span>
        <h3 class="cp-cat-name"><em>Evening</em> Dresses</h3>
        <div class="cp-cat-ar">ÙØ³Ø§ØªÙŠÙ† Ø³Ù‡Ø±Ø©</div>
        ...
        <span class="cp-cat-arrow">Explore Evening â†’</span>
      </div>
    </a>

    <!-- Dresses -->
    <a href="<?php echo esc_url( home_url("/collection/dresses/") ); ?>" id="dresses" class="cp-cat dr rv rv-d2">
      <div class="cp-cat-img" style="background-image:url('https://images.unsplash.com/photo-1566174053879-31528523f8ae?w=1200&q=85&auto=format');"></div>
      <div class="cp-cat-ov"></div>
      <div class="cp-cat-frame"></div>
      ...
      <div class="cp-cat-ct">
        ...
        <div class="cp-cat-ar">ÙØ³Ø§ØªÙŠÙ†</div>
        <p class="cp-cat-desc">Day, brunch, and afternoon silhouettes.</p>
        <span class="cp-cat-arrow">Explore â†’</span>
      </div>
    </a>

    <!-- New Arrivals -->
    <a href="<?php echo esc_url( home_url("/collection/new-arrivals/") ); ?>" id="new" class="cp-cat na rv rv-d3">
      <div class="cp-cat-img" style="background-image:url('https://images.unsplash.com/photo-1581044777550-4cfa60707c03?w=1200&q=85&auto=format');"></div>
      <div class="cp-cat-ov"></div>
      <div class="cp-cat-frame"></div>
      <span class="cp-cat-num">03 / 07</span>
      <div class="cp-cat-ct">
        <span class="cp-cat-tag">New Season Â· 28 pieces</span>
        <h3 class="cp-cat-name">New Arrivals</h3>
        <div class="cp-cat-ar">ÙˆØµÙ„ Ø­Ø¯ÙŠØ«Ø§Ù‹</div>
        <p class="cp-cat-desc">Just landed â€” SS26.</p>
        <span class="cp-cat-arrow">Discover â†’</span>
      </div>
    </a>

    <!-- Blouses -->
    <a href="<?php echo esc_url( home_url("/collection/blouses/") ); ?>" id="blouses" class="cp-cat bl rv rv-d2">
      <div class="cp-cat-img" style="background-image:url('https://images.unsplash.com/photo-1485968579580-b6d095142e6e?w=1200&q=85&auto=format');"></div>
      <div class="cp-cat-ov"></div>
      <div class="cp-cat-frame"></div>
      ...
      <div class="cp-cat-ct">
        ...
        <div class="cp-cat-ar">Ø¨Ù„ÙˆØ²Ø§Øª</div>
    ...
    <a href="<?php echo esc_url( home_url("/collection/skirts/") ); ?>" id="skirts" class="cp-cat sk rv rv-d3">
      <div class="cp-cat-img" style="background-image:url('https://images.unsplash.com/photo-1572804013427-4d7ca7268217?w=1200&q=85&auto=format');"></div>
      <div class="cp-cat-ov"></div>
      <div class="cp-cat-frame"></div>
      ...
      <div class="cp-cat-ct">
        ...
        <div class="cp-cat-ar">ØªÙ†Ø§Ù†ÙŠØ±</div>
    ...
    <a href="<?php echo esc_url( home_url("/collection/trousers-slacks/") ); ?>" id="trousers" class="cp-cat tr rv rv-d4">
      <div class="cp-cat-img" style="background-image:url('https://images.unsplash.com/photo-1539109136881-3be0616acf4b?w=1200&q=85&auto=format');"></div>
      <div class="cp-cat-ov"></div>
      <div class="cp-cat-frame"></div>
      ...
      <div class="cp-cat-ct">
        ...
        <div class="cp-cat-ar">Ø¨Ù†Ø§Ø·ÙŠÙ„</div>
        <p class="cp-cat-desc">Tailored, wide-leg, and statement silhouettes.</p>
        <span class="cp-cat-arrow">Explore â†’</span>
      </div>
    </a>

    <!-- Accessories â€” Wide banner -->
    <a href="<?php echo esc_url( home_url("/collection/accessories/") ); ?>" id="accessories" class="cp-cat ac rv rv-d4">
      <div class="cp-cat-img" style="background-image:url('https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=1800&q=85&auto=format');background-position:center 60%;"></div>
      <div class="cp-cat-ov"></div>
      <div class="cp-cat-frame"></div>
      <span class="cp-cat-num">07 / 07</span>
      <div class="cp-cat-ct">
        <div>
          <span class="cp-cat-tag">20 pieces Â· Curated edit</span>
          <h3 class="cp-cat-name">Accessories</h3>
          <div class="cp-cat-ar">Ø¥ÙƒØ³Ø³ÙˆØ§Ø±Ø§Øª</div>
          <p class="cp-cat-desc">Clutches, statement jewellery, evening minaudiÃ¨res â€” the finishing notes that complete a look.</p>
        </div>
        <span class="cp-cat-arrow">Explore Accessories â†’</span>
      </div>
    </a>
  </div>
</section>

<!-- â•â•â• EDITORIAL STATEMENT â•â•â• -->
<section class="cp-statement rv">
  <p class="cp-statement-q">A wardrobe is not assembled â€” it is <em>composed</em>. Every category in our collection is a different note in the same <em>song</em>.</p>
  <div class="cp-statement-rule"></div>
  <p class="cp-statement-src">The Bloom Atelier</p>
</section>

<!-- â•â•â• FEATURED THIS SEASON â•â•â• -->
...
<!-- â•â•â• DESIGNER STRIP â•â•â• -->
<section class="cp-des-strip rv">
  <div class="cp-des-strip-l">Eight Maisons</div>
  <h3 class="cp-des-strip-h">Every piece in this collection is the work of a designer we know by name â€” and often, personally.</h3>
  <a href="<?php echo esc_url( home_url("/") ); ?>#designers" class="cp-des-strip-cta">Explore by maison â†’</a>
</section>

<!-- â•â•â• CONSULTATION CTA â•â•â• -->
<section class="consult" id="consult">
  <div class="consult-bg" style="background-image:url('https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=1800&q=85&auto=format');"></div>
  ...
  <div class="consult-in rv">
    ...
    <p class="con-sub">Experience BLOOM the way it was meant to be experienced â€” personally. Our stylists are ready to curate a selection from across all seven categories for your occasion.</p>
    <div class="con-btns">
...
<script>
/* â•â•â• FEATURED PRODUCTS (a curated subset across categories) â•â•â• */
const PRODUCTS=[
  {designer:'Elie Saab',name:'Embroidered Tulle Cape Gown',price:5195,occasion:'Evening',badge:'Riyadh Exclusive',img:'https://images.unsplash.com/photo-1566174053879-31528523f8ae?w=800&q=85&auto=format',size:'Size 38'},
  {designer:'Zuhair Murad',name:'Silk Organza Column Dress',price:4295,occasion:'Evening',badge:'Limited Piece',img:'https://images.unsplash.com/photo-1581044777550-4cfa60707c03?w=800&q=85&auto=format',size:'Size 40'},
  ...
  prodGrid.innerHTML=PRODUCTS.map((p,i)=>`
    <div class="p-card rv rv-d${(i%4)+1}">
      <div class="p-img">
        ...
        <div class="p-hover">
          <button class="p-hover-btn p-add-bag" >Inquire on WhatsApp</button>
...
/* â•â•â• MOTION â€” MAGNETIC CTAs â•â•â• */
...
/* â•â•â• STICKY TAB SCROLL-SPY â•â•â• */
...
/* â•â•â• RIPPLE ON CTA CLICK â•â•â• */
