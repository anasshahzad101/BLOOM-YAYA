...
<div class="whisper">
  <span class="whisper-track">
    <span>GCC-wide delivery</span><span class="dot">âœ¦</span><span>Kingdom Mall, Riyadh</span><span class="dot">âœ¦</span><span>Complimentary styling consultation</span><span class="dot">âœ¦</span><span>Spring / Summer 2026</span>
  </span>
</div>
...
<section class="ph-hero" id="phHeroSection" aria-labelledby="phTitle">
  <div class="ph-hero-img" style="background-image:url('https://images.unsplash.com/photo-1581338834647-b0fb40704e21?w=2000&q=85&auto=format');" role="img" aria-label="BLOOM atelier interior"></div>
  ...
  <div class="ph-hero-ct">
    ...
    <p class="ph-sub">Sixteen years on King Fahd Road. Forty-two seasons of trunk shows. One single, unchanging idea â€” that a gown is not a garment, but a promise.</p>
  </div>
</section>
...
<section class="ab-story">
  <div class="ab-story-grid">
    <div class="ab-story-img rv">
      <div class="ab-story-img-bg" style="background-image:url('https://images.unsplash.com/photo-1494578379344-d6c710782a3d?w=1200&q=85&auto=format');" role="img" aria-label="The original showroom"></div>
...
<section class="ab-values">
  ...
  <div class="ab-values-grid">
    <div class="ab-value rv rv-d1">
      ...
      <p class="ab-value-p">We do not carry every designer. We carry the ones whose work makes us stop in the showroom â€” and that is the only filter that has ever mattered to us.</p>
    </div>
    <div class="ab-value rv rv-d2">
      <div class="ab-value-icon">II</div>
      <h3 class="ab-value-h">Time, not urgency.</h3>
      <p class="ab-value-p">An appointment at BLOOM is unhurried by design. You are not buying a dress â€” you are choosing the gown that will outlive the photograph. That deserves time.</p>
    </div>
...
<section class="ab-timeline" id="timeline">
  ...
  <div class="ab-tl-list" id="tlList">
    ...
    <article class="ab-tl-row rv"><div class="ab-tl-yr"><em>2026</em></div><div class="ab-tl-content"><h3 class="ab-tl-h">The Vow Collection.</h3><p class="ab-tl-p">Our SS26 lookbook is shot at Al Murabba Palace â€” twelve looks, seven maisons, one season.</p></div></article>
  </div>
</section>
...
<!-- ATELIER GALLERY -->
<section class="ab-atelier">
  <div class="ab-atelier-head rv">
    <div class="sec-eyebrow" style="justify-content:center;">Inside the Atelier</div>
    <h2 class="sec-title">Where the <em>conversations</em> happen.</h2>
  </div>
  <div class="ab-atelier-grid">
    <div class="ab-at a rv rv-d1"><div class="ab-at-img" style="background-image:url('https://images.unsplash.com/photo-1581044777550-4cfa60707c03?w=1200&q=85&auto=format');" role="img" aria-label="Showroom interior"></div><div class="ab-at-frame"></div></div>
    <div class="ab-at b rv rv-d2"><div class="ab-at-img" style="background-image:url('https://images.unsplash.com/photo-1566174053879-31528523f8ae?w=900&q=85&auto=format');" role="img" aria-label="Evening gown rack"></div><div class="ab-at-frame"></div></div>
    <div class="ab-at c rv rv-d3"><div class="ab-at-img" style="background-image:url('https://images.unsplash.com/photo-1485968579580-b6d095142e6e?w=900&q=85&auto=format');" role="img" aria-label="Consultation suite"></div><div class="ab-at-frame"></div></div>
    <div class="ab-at d rv rv-d2"><div class="ab-at-img" style="background-image:url('https://images.unsplash.com/photo-1581044777550-4cfa60707c03?w=1200&q=85&auto=format');background-position:center 60%;" role="img" aria-label="Bridal suite"></div><div class="ab-at-frame"></div></div>
    <div class="ab-at e rv rv-d3"><div class="ab-at-img" style="background-image:url('https://images.unsplash.com/photo-1539109136881-3be0616acf4b?w=900&q=85&auto=format');" role="img" aria-label="Atelier fitting"></div><div class="ab-at-frame"></div></div>
    <div class="ab-at f rv rv-d4"><div class="ab-at-img" style="background-image:url('https://images.unsplash.com/photo-1539109136881-3be0616acf4b?w=1400&q=85&auto=format');" role="img" aria-label="Boutique display"></div><div class="ab-at-frame"></div></div>
  </div>
</section>
...
<section class="ab-founder rv">
  ...
  <p class="ab-founder-q">We do not sell <em>dresses</em>. We help women dress for the <em>most photographed evenings</em> of their lives. That is a different kind of <em>responsibility</em> â€” and we have spent sixteen years learning to honour it.</p>
  <div class="ab-founder-img" style="background-image:url('https://images.unsplash.com/photo-1494578379344-d6c710782a3d?w=200&q=85&auto=format');"></div>
...
/* Timeline progress line (fills as you scroll 2010 â†’ 2026) */
