...
<div class="whisper"><span class="whisper-track"><span>GCC-wide delivery</span><span class="dot">âœ¦</span><span>Kingdom Mall, Riyadh</span><span class="dot">âœ¦</span><span>Inquire on WhatsApp</span><span class="dot">âœ¦</span><span>Spring / Summer 2026</span></span></div>
...
<section class="ph-hero" id="phHeroSection">
  <div class="ph-hero-img" style="background-image:url('https://images.unsplash.com/photo-1581044777550-4cfa60707c03?w=2000&q=85&auto=format');"></div>
  ...
  <div class="ph-hero-ct">
    ...
    <div class="ph-eyebrow"><?php echo (int) $total; ?> Pieces Â· Curated</div>
...
<section class="prod" style="background:var(--ivory);padding:80px 56px;">
  ...
  <div style="text-align:center;padding:80px 20px;color:var(--txt-gray);">
    ...
    <p style="font-size:16px;max-width:480px;margin:0 auto 24px;">Add your first product from <strong>Products â†’ Add Product</strong> in the WordPress admin.</p>
    <a href="<?php echo esc_url( admin_url('post-new.php?post_type=bloom_product') ); ?>" class="btn-gold"><span>Add a product</span><span class="arrow">â†’</span></a>
  </div>
  <?php endif; ?>
</section>
...
<section class="consult" id="consult">
  ...
  <div class="consult-in">
    ...
    <p class="con-sub">Our stylists can source by request â€” from past-season archive to the latest runway. Tell us what you're searching for, we'll find it.</p>
    <div class="con-btns">
